...
3. Запуск:
   ...
   В репозитории есть пример словаря `dictionaries/example.txt`. Свои колоды положите в `dictionaries/` или загрузите через `/dict_upload`.
...
Словари в `dictionaries/` — отдельные текстовые файлы; добавляйте только те списки слов, на распространение которых у вас есть права.
